...
const library: Record<Category, Array<Omit<Product, 'id' | 'category'>>> = {
  Book: [
    ...
    },
    {
      ...
      price: 12.99,
      stock: 22,
      imageUrl: 'https://images.unsplash.com/photo-1463320898484-cdee8141c787?auto=format&fit=crop&w=800&q=80',
  ...
  Newspaper: [
    ...
    },
    {
      ...
      price: 3.5,
      stock: 95,
      imageUrl: 'https://images.unsplash.com/photo-1513343041531-167ff87cfa54?auto=format&fit=crop&w=800&q=80',
    ...
    },
    {
      ...
      price: 3.75,
      stock: 70,
      imageUrl: 'https://images.unsplash.com/photo-1473181488821-2d23949a045a?auto=format&fit=crop&w=800&q=80',
